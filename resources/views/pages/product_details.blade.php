		...
		<div class="product-details"><!--product-details-->
			...
			<div class="col-sm-7">
				<div class="product-information"><!--/product-information-->
					...
					<img src="{{URL::to('fronted/images/product-details/rating.png')}}" alt="" />
					<span>
						<span>{{$product_by_details->product_price}} T</span>
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="#">
										...
										<b>Rating: </b> <img src="{{URL::to('fronted/images/product-details/rating.png')}}" alt="" />
